...
VALUES ('admin@grademe.com', '$2b$10$6KVlrJnVVJwgv3QXjxKObeK1j2f/3TlzSUgY72VBgOwvjbY.dBZrm', 'Admin User', 'admin', TRUE)
...
BEGIN
    ...
    -- Insert student users with bcrypt hashed passwords (student123)
    INSERT INTO users (email, password, name, role, is_admin, student_id)
    VALUES ('john@example.com', '$2b$10$QlcC8UVnQXqPYrLDnDv67eAGMCW7jozQUL1/aVCvvI5iLYdmJIAG6', 'John Doe', 'student', FALSE, john_id)
    ON CONFLICT (email) DO NOTHING;

    INSERT INTO users (email, password, name, role, is_admin, student_id)
    VALUES ('jane@example.com', '$2b$10$QlcC8UVnQXqPYrLDnDv67eAGMCW7jozQUL1/aVCvvI5iLYdmJIAG6', 'Jane Smith', 'student', FALSE, jane_id)
    ON CONFLICT (email) DO NOTHING;
END $$;
